package com.example.buaa.minitiktok.monindicator;
...
public class MonIndicator extends View {
	...
	private int[] colors = new int[]{0xFF555555, 0xFF555555, 0xFF555555, 0xFF555555, 0xFF555555};
	...
	public MonIndicator(Context context, AttributeSet attrs) {
		...
		int cycle = a.getInt(R.styleable.monindicator_cycle, 400);//周期，默认为2秒
		cycle = cycle/2;
