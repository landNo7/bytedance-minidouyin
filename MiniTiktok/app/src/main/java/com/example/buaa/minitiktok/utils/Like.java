...
public class Like extends RelativeLayout {
    ...
    private void initView(Context context) {
        mContext = context;
        Log.d(TAG, "initView: listener is :" + (onClickListener!=null) );
    }
        ...
        switch (event.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                if(interval <INTERVAL ){//小于1秒，拦截事件，并做处理
                    ...
                    //设置图片资源
                    imageView.setImageDrawable(getResources().getDrawable(R.drawable.love,null));
    ...
    public void setOnClickListener(MyClickListener onClickListener) {
        this.setOnTouchListener(onClickListener);
        //Log.d(TAG, "setOnClickListener:  listener is :" + (onClickListener!=null));
    }
