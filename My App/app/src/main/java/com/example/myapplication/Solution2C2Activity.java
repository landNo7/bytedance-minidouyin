...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private String student_id = "16061084";
    private String user_name = "陆启浩";
    ...
    private void postVideo() {
        ...
        MultipartBody.Part mImage = getMultipartFromUri("cover_image",mSelectedImage);
        MultipartBody.Part mVideo = getMultipartFromUri("video",mSelectedVideo);
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://test.androidcamp.bytedance.com/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        Log.d(TAG, "postVideo: come here");
        Call<PostVideoResponse> call =  retrofit.create(IMiniDouyinService.class).UploadFiles(student_id,user_name,mImage,mVideo);
    ...
    public void fetchFeed(View view) {
        ...
        call.enqueue(new Callback<FeedResponse>() {
            ...
            public void onResponse(Call<FeedResponse> call, Response<FeedResponse> response) {
                ...
                resetRefreshBtn();
                Toast.makeText(Solution2C2Activity.this, "刷新成功", Toast.LENGTH_LONG).show();
            }
            ...
            public void onFailure(Call<FeedResponse> call, Throwable throwable) {
                ...
                resetRefreshBtn();
                Toast.makeText(Solution2C2Activity.this, "刷新失败，请重试", Toast.LENGTH_LONG).show();
            }
        });
    }
